                            ...
                            <tr>
								...
								<td style="text-align: center;">
									...
									<a href="{{route('artikel.edit', $data->id)}}"
										class="btn btn-success btn-sm edit-artikel"> <i class="fa fa-pencil  "></i>
                                    </a>
                                    <a href="{{route('artikel.show', $data->id)}}"
										class="btn btn-warning btn-sm lihat-data"> <i class="fa fa-eye  "></i>
									</a>
										<input type="hidden" name="_method" value="DELETE">
										<button type="submit" class="btn btn-danger btn-sm hapus-artikel"> <i class="fa fa-trash  "></i></button>
									</form>
								</td>
                            </tr>
                            @endforeach
